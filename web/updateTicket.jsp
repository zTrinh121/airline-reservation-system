<%-- 
    ...
    Created on : Mar 10, 2024, 1:10:58 AM
    Author     : ThanhThuy
--%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<jsp:useBean id="ticketList" class="dao.TicketDAO" />
<!DOCTYPE html>
<html>
    <head>
        ...
        <form action="ticketController" >
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="ticketClass">
                    ...
                    <option value="Business" ${ticket.ticketClass == 'Business' ? 'selected' : ''}>Business</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="bookingStatus">
                    <option value="Confirmed" ${ticket.bookingStatus == 'Confirmed' ? 'selected' : ''}>Confirmed</option>
                    <option value="Pending" ${ticket.bookingStatus == 'Pending' ? 'selected' : ''}>Pending</option>
                </select>
            </div>
