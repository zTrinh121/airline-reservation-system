<%-- 
    Document   : offers
    Created on : Mar 8, 2024, 2:05:49 PM
    Author     : HP
--%>
...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" integrity="sha384-..." crossorigin="an
              </head>
                    ...
                    <div class="col d-flex flex-row">
                        ...
                        <div class="user_box ml-auto justify-content-end" style="display: flex; align-items: center; position: relative;">
                            ...
                            <div id="avatarDropdown" class="dropdown-content">
                                ...
                                <a href="<%= request.getContextPath()%>/profile.jsp">Show Profile</a>
                                <a href="<%= request.getContextPath()%>/password.jsp">Change Password</a>
                            </div>
                            <% }%>
                        </div>
                            ...
                            <div class="search_panel active">
                                <form action="#" id="search_form_1" class="search_panel_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
                                    <div class="search_item">
                                        <div>From city</div>
                                        <input type="text" class="destination search_input" required="required" name="fcity">
                                    </div>
                                    <div class="search_item">
                                        <div>To city</div>
                                        <input type="text" class="check_in search_input" placeholder="" name="tcity">
                                    </div>
                                    <div class="search_item">
                                        <div>Departure Time</div>
                                        <input type="text" class="check_out search_input" placeholder=""name="time1">
                                    </div>

                                    <div class="search_item">
                                        <div>Arrival Time</div>
                                        <input type="text" class="check_out search_input" placeholder="" name="time2">
                    ...
                    <div class="offers_grid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <div class="offers_content">
                                        <div class="offers_price">$70<span>Da Nang</span></div>
                        ...
                        <div class="offers_item rating_3">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <div class="offers_content">
                                        <div class="offers_price">$50<span>Nha Trang</span></div>
                        ...
                        <div class="offers_item rating_5">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <div class="offers_content">
                                        <div class="offers_price">$110<span>Ha Noi</span></div>
                        ...
                        <div class="offers_item rating_4">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <div class="offers_content">
                                        <div class="offers_price">$50<span>Ho Chi Minh</span></div>
                                        <div class="rating_r rating_r_4 offers_rating" data-rating="4">
                                            <i></i>
                                            <i></i>
                                            <i></i>
                        ...
                        <div class="offers_item rating_3">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <div class="offers_content">
                                        <div class="offers_price">$90<span>Phu Quoc</span></div>
                                        <div class="rating_r rating_r_3 offers_rating" data-rating="3">
                                            <i></i>
                                            <i></i>
                                            <i></i>
                        ...
                        <div class="footer_content footer_contact">
                            <ul class="contact_info_list">
                                ...
                                <li class="contact_info_item d-flex flex-row">
                                    ...
                                    <div class="contact_info_text"><a href="mailto:contactme@gmail.com?Subject=Hello" target="_top">FlightHome@gmail.com</a></div>
                                </li>
                                <li class="contact_info_item d-flex flex-row">
