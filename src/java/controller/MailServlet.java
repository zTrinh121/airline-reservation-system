...
public class MailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String subject = "Thanks for your subscription";
        String message = "Dear, " + name + ".\n\n" +
                 "I hope this letter finds you well. This is to inform you about the latest updates...\n" +
                 "Please let me know if you have any questions or concerns.\n\n" +
                 "Best regards,\n" +
                 "HomeFight";
        MailDAO md  = new MailDAO();
        md.send(to, subject, message);
        request.setAttribute("mess", subject);
